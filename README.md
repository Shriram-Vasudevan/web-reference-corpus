...
```bash
# 1) Build seed URL list from award sites, curated lists, etc.
...
- `scripts/00_build_seeds.py` — builds the seed URL list from award sites and curated sources
